...
from electrum_monetaryunit.keystore import bip39_normalize_passphrase
from electrum_monetaryunit.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the MonetaryUnit in the wallet.") % self.device
        else:
