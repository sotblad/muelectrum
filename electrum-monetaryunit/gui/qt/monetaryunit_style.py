"""MonetaryUnit look and feel."""

monetaryunit_stylesheet = """
...
QComboBox::down-arrow {
    border-image: url(':/icons/monetaryunit_downArrow.png') 0 0 0 0 stretch stretch;
}
...
QScrollBar:up-arrow {
    background-image: url(':/icons/monetaryunit_upArrow_small.png');
}

QScrollBar:down-arrow {
    background-image: url(':/icons/monetaryunit_downArrow_small.png');
}

QScrollBar:left-arrow {
    background-image: url(':/icons/monetaryunit_leftArrow_small.png');
}

QScrollBar:right-arrow {
    background-image: url(':/icons/monetaryunit_rightArrow_small.png');
}
