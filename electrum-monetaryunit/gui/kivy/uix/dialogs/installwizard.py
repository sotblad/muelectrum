...
from electrum_monetaryunit_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_monetaryunit.mnemonic import Mnemonic
        from electrum_monetaryunit.old_mnemonic import words as old_wordlist
