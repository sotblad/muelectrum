...
pyinstaller \
    -y \
    --name electrum-monetaryunit-$ELECTRUM_MUE_VERSION.bin \
    osx.spec

sudo hdiutil create -fs HFS+ -volname "Electrum-MUE" \
    -srcfolder dist/Electrum-MUE.app \
    dist/electrum-monetaryunit-$ELECTRUM_MUE_VERSION-macosx.dmg
