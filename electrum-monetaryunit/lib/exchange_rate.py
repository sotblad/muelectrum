...
class Bittrex(ExchangeBase):
    def get_rates(self, ccy):
        json = self.get_json('bittrex.com',
                             '/api/v1.1/public/getticker?market=BTC-MUE')
        quote_currencies = {}
...
class Poloniex(ExchangeBase):
    def get_rates(self, ccy):
        ...
        quote_currencies = {}
        monetaryunit_ticker = json.get('BTC_MUE')
        quote_currencies['BTC'] = Decimal(monetaryunit_ticker['last'])
        return quote_currencies


class CoinMarketCap(ExchangeBase):
    def get_rates(self, ccy):
        json = self.get_json('api.coinmarketcap.com', '/v1/ticker/monetaryunit/')
        quote_currencies = {}
