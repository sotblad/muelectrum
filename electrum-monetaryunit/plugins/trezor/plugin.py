...
from electrum_monetaryunit.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
...
from electrum_monetaryunit.transaction import deserialize, Transaction
from electrum_monetaryunit.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "MonetaryUnit Testnet" if TESTNET else "MonetaryUnit"
