...
from electrum_monetaryunit.bitcoin import COIN
from electrum_monetaryunit.i18n import _
from electrum_monetaryunit.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 1000 MUE output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 1000 MUE output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 1000 MUE was sent to'))
...
class MasternodeOutputsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        desc = ' '.join(['Use this tab to scan for and choose a collateral payment for your masternode.',
            'A valid collateral payment is exactly 1000 MUE.'])
        desc = QLabel(_(desc))
    ...
    def scan_for_outputs(self, include_frozen):
        ...
        if len(coins) > 0:
            ...
            self.status_edit.setText(_('No 1000 MUE outputs were found.'))
