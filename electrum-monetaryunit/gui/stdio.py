...
from electrum_monetaryunit.util import format_satoshis, set_verbosity
from electrum_monetaryunit.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_monetaryunit.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-monetaryunit create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-monetaryunit setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-monetaryunit setconfig' to change your settings")
        return True
